...
print("--------------------Load test--------------------")
X_input_test = np.load('./X_input_split_test_zero/X_input_0.npy')
for i in range(1, 10):
    X_input_test = np.concatenate((X_input_test, np.load('./X_input_split_test_zero/X_input_'+str(i)+'.npy')))
...
np.save('./Y_prediction/Y_pred_feature.npy', y_prediction)
