...
Values_counter = {0: 1589923, #1589923
                  ...
                  6: 4057, #4057
                  7: 5555, #5555
                  8: 8,         #8 de base, on change , Heartbleed  1
                  9: 10000,        #25 de base, on change, Infiltration  2
                  10: 111163, #111163
                  11: 4128, #4128
                  12: 1055, #1055, Brute force  3
                  13: 15,       #15 de base, on change , SQL inject  4
                  14: 456,      #456 de base, on change  5
                  }
...
split_npy_save(X_input, 20, 'X_input_split_train_n0_smote_2')
#np.save('./X_input_split_test/Y_test.npy_no0_smote', Y_test)
np.save('./X_input_split_train/Y_n0_smote_2.npy', Y)
