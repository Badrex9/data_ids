...
d_model = 1
seq_len = np.shape(X_test)[1] #np.shape(X_input)[1] #Longueur du vecteur d'entrée (d_model) normalement 82
...
transformer.load_state_dict(torch.load(PATH, map_location=torch.device('cpu')), strict=False)
